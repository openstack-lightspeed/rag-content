                        ...
                        if new_blocks and new_blocks[-1] == prev_block:
                            ...
                            header = {
                                ...
                                "c": [
                                    header_level,
                                    ["", [], []],
                                    strip_formatting_from_inlines(term_inlines),
                                ],
                            }
        ...
        if block_type == "Header":
            ...
            stripped_header = {
                ...
                "c": [
                    current_level,
                    header_attrs,
                    strip_formatting_from_inlines(header_inlines),
                ],
            }
                ...
                if first_block.get("t") == "Para":
                    ...
                    header = {
                        ...
                        "c": [
                            header_level,
                            ["", [], []],
                            strip_formatting_from_inlines(para_inlines),
                        ],
                    }
                    new_blocks.append(header)
                else:
        ...
        if book_title_inlines:
            title_header = {
                ...
                "c": [
                    1,
                    ["", [], []],
                    strip_formatting_from_inlines(book_title_inlines),
                ],
            }
